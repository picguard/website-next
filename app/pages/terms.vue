<template>
  <div>
    <UiSection title="Terms and Conditions" description="Last updated: December 29, 2022" size="lg" spacing="xl"
      align="center">
      <div class="max-w-3xl mx-auto text-left space-y-12">
        ...
        <div class="space-y-6">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Interpretation and Definitions
          </h2>

          <div class="space-y-4">
            <h3 class="text-xl font-medium text-gray-900 dark:text-white">Interpretation</h3>
          ...
          <div class="space-y-4">
            <h3 class="text-xl font-medium text-gray-900 dark:text-white">Definitions</h3>
            <p class="text-gray-600 dark:text-gray-300">For the purposes of these Terms and Conditions:</p>
            <ul class="list-disc pl-6 space-y-3 text-gray-600 dark:text-gray-300">
              ...
              <li>
                <strong>Country</strong> refers to: Sachsen, Germany.
              </li>
              <li>
        ...
        <!-- Acknowledgment -->
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Acknowledgment</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Links to Other Websites</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <!-- Termination -->
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Termination</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Limitation of Liability</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <!-- Disclaimer -->
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">"AS IS" and "AS AVAILABLE"
            Disclaimer</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <!-- Governing Law -->
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Governing Law</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <!-- Disputes Resolution -->
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Disputes Resolution</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <!-- EU Users -->
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">For European Union (EU) Users
          </h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <!-- US Legal Compliance -->
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">United States Legal Compliance
          </h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div class="space-y-6">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Severability and Waiver</h2>

          <div class="space-y-4">
            <h3 class="text-xl font-medium text-gray-900 dark:text-white">Severability</h3>
            <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div class="space-y-4">
            <h3 class="text-xl font-medium text-gray-900 dark:text-white">Waiver</h3>
            <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Translation Interpretation
          </h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Changes to These Terms and
            Conditions</h2>
          <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
